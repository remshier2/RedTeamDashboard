...
import type { Finding, FindingImport, FindingPhase, Severity } from "@/lib/types";
      ...
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">
            Paste or upload CSV / JSON. All imports land as{" "}
            <em>pending validation</em> for analyst review.
          </p>
        </div>
